...
TEST(Question2, Part_B_1) {
	...
	QueueB queue_operator_stack, second_queue;
	infix_to_postfix_B1(infix, postfix, queue_operator_stack, second_queue);
...
TEST(Question2, Part_B_2) {
	...
	QueueB queue_operator_stack, second_queue;
	infix_to_postfix_B2(infix, postfix, queue_operator_stack, second_queue);
	while (!queue_operator_stack.is_empty()) {
...
TEST(Question2, Part_C_1) {
	...
	QueueC queue_operator_stack, second_queue; // Same as in Part B, pass the reversed string to the Queue infix to postfix converter
	infix_to_postfix_C(reversed_infix, postfix, queue_operator_stack, second_queue);
...
TEST(Question2, Part_C_2) {
	...
	QueueC queue_operator_stack, second_queue;
	infix_to_postfix_C(reversed_infix, postfix, queue_operator_stack, second_queue);
	while (!queue_operator_stack.is_empty()) {
